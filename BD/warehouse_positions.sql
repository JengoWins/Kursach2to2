...
CREATE TABLE `positions` (
  ...
  `positions` varchar(150) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `positions` VALUES (1,'admin'),(2,'Equipment Manager'),(3,'Book Manager');
