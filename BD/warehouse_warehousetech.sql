...
--
-- Table structure for table `warehousetech`
--

DROP TABLE IF EXISTS `warehousetech`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `warehousetech` (
  ...
  PRIMARY KEY (`id`),
  KEY `warehouse_ibfk_1_idx` (`id_towar`),
...
--
-- Dumping data for table `warehousetech`
--

LOCK TABLES `warehousetech` WRITE;
/*!40000 ALTER TABLE `warehousetech` DISABLE KEYS */;
INSERT INTO `warehousetech` VALUES (4,8,2,6,2);
